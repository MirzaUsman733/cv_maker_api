...
router.put(
  ...
  [
    body('cv_info.user.first_name').optional().isString().withMessage('First name must be a string'),
    body('cv_info.user.email').optional().isEmail().withMessage('Must be a valid email')
  ],
